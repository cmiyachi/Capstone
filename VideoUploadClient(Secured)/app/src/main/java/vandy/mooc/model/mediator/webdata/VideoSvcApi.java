...
public interface VideoSvcApi {
	...
	public void likeVideo(@Path("id") long id,  @Body String emptyString, Callback<Video> myCallback);

    @POST(VIDEO_SVC_PATH+"/{id}/unlike")
    public void unlikeVideo(@Path("id") long id, @Body String emptyString, Callback<Video> myCallback);

    @GET(VIDEO_SVC_PATH+"/{id}/likedby")
    public Collection<Video> getUsersWhoLikedVideo(@Path("id") long id);
